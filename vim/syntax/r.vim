...
syn match    rFunction /\<cbind\>/
syn match    rFunction /\<print\>/
syn match    rFunction /\<length\>/
syn match    rFunction /\<rownames\>/
syn match    rFunction /\<png\>/
syn match    rFunction /\<plot\>/
syn match    rFunction /\<legend\>/
syn match    rFunction /\<text\>/
syn match    rFunction /\<abline\>/
syn match    rFunction /\<predict\>/
syn match    rFunction /\<dev\.off\>/
syn match    rFunction /\<is\.null\>/
syn match    rFunction /\<is\.na\>/
syn match    rFunction /\<is\.nan\>/
